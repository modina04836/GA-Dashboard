...
<body>
		<div id="box-left">
	    		<iframe id="frame" src="scrollPage.html"></iframe>
		</div>
		...
		<script type="text/javascript">
			...
			// var zx = document.getElementById("frame");
                                                       

			$(document).ready(function(){
				$("#frame, #box-left, #box-right").css("height", window.innerHeight);
				$("#view-selector-container").hide();
			});
			// $(document).on("pageload",function(){
			//   $("#embed-api-auth-container").click();
			// });
...
<!-- https://www.geckoboard.com/learn/guides/google-analytics-and-filters/#.V3baI_krJmM -->
</body>
</html>

<!-- <div class="gapi-analytics-auth-styles-signinbutton gapi-analytics-auth-styles-signinbutton:hover" title="Access Google Analytics"><span class="gapi-analytics-auth-styles-signinbutton-image"></span><span class="gapi-analytics-auth-styles-signinbutton-buttonText">Access Google Analytics</span></div> -->
